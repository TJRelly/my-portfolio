    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-4 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <p>Project</p>
          <h2 className="text-transparent bg-gradient-to-r from-[#D7BE69] via-gray-600 to-[#D7BE69] bg-clip-text">Overview</h2>
          <p className="pt-4">
            This app was built using React JS for the front end and Express JS
            for the backend. It is hosted on Github and Render. Users are able
