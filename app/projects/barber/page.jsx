      ...
      <div className="max-w-[1240px] mx-auto p-6 grid md:grid-cols-4 gap-8 pt-8">
        <div className="col-span-3">
          ...
          <p className="pt-4 max-w-[750px]">
            For this project, I developed a responsive business landing page
            based on a designed layout. The mobile version of the landing page
            incorporates a sliding navigation feature, which was achieved using
        ...
        <Link href="/#projects">
          <p className="underline cursor-pointer hover:text-[#C49F00] ease-in duration-300 p-4">
            Back
          </p>
        </Link>
      </div>
