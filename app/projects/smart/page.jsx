                ...
                <div className="max-w-[1240px] mx-auto p-6 grid md:grid-cols-4 gap-8 pt-8">
                    <div className="col-span-3">
                        ...
                        <p className="pt-4 max-w-[750px]">
                            An advanced facial detection software that
                            accurately identifies and locates faces within
                            images.
                        </p>
                        <p className="pt-4 max-w-[750px]">
                            {
                        ...
                        <a
                            href="https://smart-brain-chi.vercel.app/"
                            target="_blank"
                        >
                        ...
                        <a
                            href="https://github.com/TJRelly/smart-brain/"
                            target="_blank"
                        >
