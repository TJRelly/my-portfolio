    ...
    >
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <p className="uppercase text-xl tracking-widest text-gray-500">About</p>
          <h2 className="py-4 text-transparent bg-gradient-to-r from-[#D7BE69] via-gray-600 to-[#D7BE69] bg-clip-text">Who I Am</h2>
          ...
          <p className="py-2">
            ...
            interests, I have also had the privilege of working as a Middle and High School math tutor,
          ...
          <p className="py-2 pb-4 underline cursor-pointer hover:text-[#C49F00] ease-in duration-300">Check out some of my latest projects.</p>
        </div>
        <div className="py-2 w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
          <Image src="/img/workspace.png" alt="workspace" width={600} height={300} className="rounded-xl"/>
        </div>
      </div>
    </div>
  );
